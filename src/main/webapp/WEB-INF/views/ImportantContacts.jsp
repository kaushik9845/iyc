...
<body>
   ...
   <div class="content-wrapper" style="  padding-bottom: 0px;  margin-top: 0px;">
        <div class="container" style="z-index: 1000;">
            ...
            <div class="row selectionDivRow">
                <div class="col-md-12">
                    <h4 class="page-head-line">Important Contacts</h4>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            <li id="1" class="menu-top-active"><a  href="ImportantContacts">Important Contacts</a></li>
				...
				<div class="col-md-8 column">
					...
					<p class="alert alert-info">These are some of the important contacts which are helpful to the public 
				like Hospitals,Government Offices.</p>
...
var url='getDirectorySearch?important='+1+'&serviceId='+0+'&areaId='+0;
var table='';
...
$("#searchButton").unbind("click").click(function()
		...
		important=$("#importants").val();
		 serviceId=$("#services").val();
		 areaId=$("#areas").val();

		 url='getDirectorySearch?important='+1+'&serviceId='+0+'&areaId='+0;
