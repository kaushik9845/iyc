		...
		<div class="panel-body">
			...
			<div class="row clearfix">
				...
				<div class="col-md-8 column">
					<h3 class="text-primary text-center bs-header">Category Master Data</h3>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<table id="category" class="display" style="height: 100%;" cellspacing="0" width="100%" height="100%">
							<thead>
								<tr>
...
var table = $('#category').DataTable({
	...
	$('#category tbody').on( 'click', '.Edit', function () {
        var data = table.row( $(this).parents('tr') ).data();
        $("#popup").attr('title','Edit Data');
        $("#popup").dialog();
        $("#textinput").val(data.category);
        
        
        $("#singlebutton").unbind("click").click(function()
        		{
        	
        	var category=$("#textinput").val();
        	var jsonObj =
            {
...
$('#category tbody').on( 'click', '.Delete', function () {
    var data = table.row( $(this).parents('tr') ).data();
	...
	$("#download").unbind("click").click(function()
			{
	$("#submitForm").attr('action','getCategoryTemplate');
