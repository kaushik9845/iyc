		...
		<div class="panel-body">
			...
			<div class="row clearfix">
				...
				<div class="col-md-8 column">
					<h3 class="text-primary text-center bs-header">Area Master Data</h3>
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						...
						<table id="area" class="display" style="height: 100%;" cellspacing="0" width="100%" height="100%">
							<thead>
								<tr>
						...
						<form:form id="fileUploadForm" modelAttribute="uploadForm"
								enctype="multipart/form-data" method="POST" action="uploadArea">
...
var table = $('#area').DataTable({
	...
	$('#area tbody').on( 'click', '.Edit', function () {
        var data = table.row( $(this).parents('tr') ).data();
        $("#popup").attr('title','Edit Data');
        $("#popup").dialog();
        $("#textinput").val(data.area);
        
        
        $("#singlebutton").unbind("click").click(function()
        		{
        	
        	var area=$("#textinput").val();
        	var jsonObj =
            {
                'id': data.id , 'areaName': area
            };
            $.ajax(
            {
                url : 'editArea',
...
$('#area tbody').on( 'click', '.Delete', function () {
	...
	$("#download").unbind("click").click(function()
			{
	$("#submitForm").attr('action','getAreaTemplate');
