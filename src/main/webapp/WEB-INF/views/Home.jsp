                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            <li id="1" class="menu-top-active"><a  href="#">Latest</a></li>
                            <li id="15"><a href="#">Thought</a></li>
                            <li id="16"><a href="#">Facts</a></li>
                            <li id="17"><a href="#">Blood Request</a></li>
                             <li id="18"><a href="#">others</a></li>
            ...
            <div class="row">
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body" style="height:475px;">
                     ...
                     <div class="countNumber"> count : ${sessionScope.count}</div> 
                </div>
