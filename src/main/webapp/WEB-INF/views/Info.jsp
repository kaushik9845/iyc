...
<img id="popupImage" src="" width='500' height="500">
</div>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
							<li ><a  href="Home" class="shine">Home</a></li>
							<li><a href="Event" >Events</a></li>

							<li><a class="menu-top-active" href="Info">Info</a></li>
    ...
    <div class="content-wrapper" style="  padding-bottom: 0px;  margin-top: 0px;">
        <div class="container" style="z-index: 1000;">
            ...
            <div class="row selectionDivRow">
                <div class="col-md-12">
                    <h4 class="page-head-line">Info</h4>
     ...
     <section class="menu-section" style="margin-bottom: 20px;">
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            <li id="30" class="menu-top-active"><a  href="#">Latest</a></li>
                            <li id="31"><a href="#">News</a></li>
                            <li id="32"><a href="#">Recipes</a></li>
                            <li id="33"><a href="#">Movie Reviews</a></li>
                            <li id="34"><a href="#">Exam Results</a></li>
                            <li id="35"><a href="#">Jobs</a></li>
                            <li id="36"><a href="#">Book Releases</a></li>
                            <li id="37"><a href="#">Articles</a></li>
                             <li id="38"><a href="#">others</a></li>
                             <li id="39"><a href="#">City Ads</a></li>
            ...
            <div class="row">
                      ...
                      <div class="notice-board">
                        <div class="panel panel-success">
                           ...
                           Latest 
                            ...
                            <div class="panel-body ListGroupH">
                               
                                <div id="shortDiv" class="list-group" >
                ...
                <div class="panel panel-success">
                    <div id="titleDetails" class="panel-heading">
                        
                    </div>
                    <div class="panel-body" style="height:475px;">
                        
                        <img id="imgSrc" src="" class="img-rounded" alt="No data" style="width: 200px;height: 140px;display: block; margin-left: auto; margin-right: auto" > 
					   
					   <div class="progress progress-striped active" style="margin-top:10px;">
						  <div class="progress-bar progress-bar-danger" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%;height:50%;">
						  </div>					   
						</div>
						<div id="description" class="alert alert-info  scrollInfo" style="height:275px;  overflow-x: hidden;  overflow-y: auto;">
