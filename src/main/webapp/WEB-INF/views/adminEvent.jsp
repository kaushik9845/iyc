...
<form:form id="fileUploadForm" modelAttribute="uploadForm"
		...
		<input id="EventId" name="EventId" style="display:none" type="text" >
				...
				<div class="row" style="margin:10px;">
					...
					<div class="col-lg-12">
						...
						<div class="col-lg-6"><textarea type="text" id="description" name="description" required></textarea></div>
					...
					<div class="col-lg-12">
						...
						<div class="col-lg-3"><label>Place</label></div>
						<div class="col-lg-3"><input id="place" name="place" type="text"></input></div>
						<div class="col-lg-3"></div>
					...
					<div class="col-lg-12">
						...
						<div class="col-lg-3"><label>Time</label></div>
						<div class="col-lg-3"><input id="schedule" name="schedule" type="datetime"></input></div>
						<div class="col-lg-3"></div>
...
<a href='Home'><img src="resources/images/logo2.png" class="headerCss" alt="Cinque Terre" id="logo" ></a>
				...
				<div class="col-md-8 column">
					<h3 class="text-primary text-center bs-header">Upload Event Details</h3>
